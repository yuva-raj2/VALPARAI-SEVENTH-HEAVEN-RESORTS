...
const HeroSection = () => {
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      {/* NAVBAR */}
      <nav className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between h-20 px-6 md:px-16">

  {/* LOGO */}
  <div className="flex items-center">
    <h2 className="text-2xl  font-bold text-primary-foreground">Greenery Heaven Cottage</h2>
  </div>
